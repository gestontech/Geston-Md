...
export default {
    ...
    run: async (context) => {
                    ...
                    interactiveMessage: {
                        ...
                        contextInfo: {
                            ...
                            externalAdReply: {
                                ...
                                thumbnail: pict,
                                mediaUrl: '',
                                sourceUrl: 'https://github.com/xhclintohn/Geston-MD',
                            ...
                            buttons: [
                                {
                                    ...
                                    buttonParamsJson: JSON.stringify({
                                        ...
                                        url: 'https://github.com/xhclintohn/Geston-MD',
                                        merchant_url: 'https://github.com/xhclintohn/Geston-MD'
                                    })
                                },
                                {
                                    name: 'single_select',
        ...
        try {
            ...
            await client.sendMessage(m.chat, { audio: audioBuffer, ptt: true, mimetype: 'audio/mpeg', fileName: 'geston-menu.m4a' });
        } catch {
            await client.sendMessage(m.chat, { audio: { url: randomFile }, ptt: true, mimetype: 'audio/mpeg', fileName: 'geston-menu.m4a' });
        }
    } };
